...
# 1. Core Principles
  →  .claude\policies\workflow_project\01_Core_Principles.md

# 2. Roles
  →  .claude\policies\workflow_project\02_Roles.md

# 3. Information Handoff Between Sessions
  →  .claude\policies\workflow_project\03_Information_Handoff_Between_Sessions.md

# 4. Task Size & Standard Pipeline
  →  .claude\policies\workflow_project\04_Task Size & Standard Pipeline.md

# 5. Document Policy
  →  .claude\policies\workflow_project\05_Document_Policy.md

# 6. Change Impact
For every task of size **L or larger**, evaluate the Change Impact before starting the work.

# 7. Review Principles
  →  .claude\policies\workflow_project\07_Review_Principles.md
...
# 13. Branch Strategy & PR Policy
  →  .claude\policies\workflow_project\Branch Strategy & PR Policy.md