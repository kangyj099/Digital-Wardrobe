...
> Version 3.0 — Single consolidated document (former `00_DesignPrinciples/` subfiles merged back into this file on 2026-07-22 for reading convenience — see `docs/history/Decision.md`). Stage 2/3 headings keep their subfile revision suffixes ("Revised"/"Revised v2"), which are the currently valid versions.

## 목차

- [Stage 1 — UX Principles](#stage-1--ux-principles)
- [Stage 2 — Interaction Principles (Revised)](#stage-2--interaction-principles-revised)
- [Stage 3 — Layout Principles (Revised v2)](#stage-3--layout-principles-revised-v2)
- [Stage 4 — Accessibility Rules](#stage-4--accessibility-rules)
- [Stage 5 — Design Tokens](#stage-5--design-tokens)
- [Stage 6 — Component Strategy](#stage-6--component-strategy)
